...
export const REGRAS_SERIE_A = {
  formato: '8 equipes · Pontos corridos (todos contra todos) · Partidas em MD2',
  inscricao: 'R$ 150,00 por time',
  premiacaoTotal: 'R$ 800,00 em PIX',
  premiacao1: 'R$ 600,00 para o 1º colocado',
  premiacao2: 'R$ 200,00 para o 2º colocado',
  permanencia: '1º ao 6º lugar garantem vaga na Série A do próximo Split',
  rebaixamento: '7º e 8º lugar são rebaixados e fundam a Série B',
};

export const REGRAS_SERIE_B = {
  formato: '8 equipes · 2 rebaixados da Série A + 6 vagas abertas',
...
export const DIVISAO_PREMIACAO_SERIE_A = [
  { colocacao: '1º lugar', valor: 'R$ 600,00' },
